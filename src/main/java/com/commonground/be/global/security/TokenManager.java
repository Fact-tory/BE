...
public class TokenManager {
    ...
    /**
     * 개별 토큰 무효화 (Refresh Token 로테이션용)
     * Refresh Token의 tokenId를 블랙리스트에 추가
     */
    public void invalidateToken(String tokenId) {
        ...
        redisTemplate.opsForValue().set(blacklistKey, "revoked", refreshTokenExpiration, TimeUnit.SECONDS);
