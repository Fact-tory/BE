 ...
 * 가상의 관리자 사용자 정보를 제공합니다. 실제 데이터베이스의 사용자가 아닌
 * 시스템 레벨의 관리자 권한을 나타냅니다.</p>
 * 
 * <h3>주요 특징:</h3>
 * <ul>
 ...
 * @since 1.0
 * @see com.commonground.be.global.security.admin.AdminTokenValidator
 * @see com.commonground.be.global.security.filters.JwtAuthorizationFilter
...
public class AdminUserDetails implements UserDetails {
     ...
     * 
     * @apiNote Spring Security의 권한 체크에서 사용됩니다.
     *          @PreAuthorize, @Secured 어노테이션과 연동됩니다.
     */
    @Override
