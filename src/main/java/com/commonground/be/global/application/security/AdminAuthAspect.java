...
public class AdminAuthAspect {
	 ...
	 * </ol>
	 * @apiNote 이 메서드는 Spring AOP에 의해 자동으로 호출되며, 직접 호출하지 않습니다.
	 */
	@Around("@annotation(adminRequired)")
	public Object checkAdminAuth(ProceedingJoinPoint joinPoint, AdminRequired adminRequired)
			throws Throwable {
	 ...
	 * @apiNote Authorization 헤더의 경우 Bearer 접두사는 AdminTokenValidator에서 처리됩니다.
	 */
	 ...
	 */
	private boolean shouldLog(AdminRequired.LogLevel eventLevel,
			AdminRequired.LogLevel configuredLevel) {
	 ...
	 * @param reason     실패 사유
	 */
	private void logSecurityFailure(String requestUri, String methodName, String clientIp,
			String reason) {
